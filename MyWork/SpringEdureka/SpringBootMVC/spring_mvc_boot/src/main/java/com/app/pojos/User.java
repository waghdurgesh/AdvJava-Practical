...
public class User extends BaseEntity {
	 ...
	 * true) private ShoppingCart cart; // User 1--->1 AadharCard => uni dir asso
	 * between Entity n Composite value type
	 * 
	 * @Embedded // OPTIONAL : added only for understanding purpose private
	 * AadharCard aadharCard; // User 1----->* PaymentCard => uni dir asso between
	 * Entity n collection of // Composite value type
	 * 
	 * @ElementCollection // Mandatory o.w : HIb throws MappingExc
	 * 
	 * @CollectionTable(name = "payment_cards", joinColumns = @JoinColumn(name =
	 * "user_id")) private List<PaymentCard> paymentCards = new ArrayList<>();
	 */
	public User() {
	 ...
	 * 
	 * // add a helper method to establish bi dir link between User n Cart public
	 * void addCart(ShoppingCart cart) { this.setCart(cart);// parent ---> child
	 * cart.setCustomer(this);// child ---> parent }
	 * 
	 * public AadharCard getAadharCard() { return aadharCard; }
	 * 
	 * public void setAadharCard(AadharCard aadharCard) { this.aadharCard =
	 * aadharCard; }
	 * 
